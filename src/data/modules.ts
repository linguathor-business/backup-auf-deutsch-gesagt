...
Als ich abends zu Hause bin, mache ich die Wohnungst\u00fcr auf, lasse die Tasche fallen und mache das Handy konsequent aus. \u00abGenug gemacht heute\u00bb, sage ich laut zu mir selbst.`,
  ...
  coreVerbs: [
    { german: "anmachen", english: "to switch on (e.g. light, coffee machine, computer)", definition: "Ein Ger\u00e4t oder Licht einschalten, damit es funktioniert.", example: "Ich will das Licht im B\u00fcro anmachen." },
    { german: "ausmachen", english: "to agree on / to switch off", definition: "1. Etwas vereinbaren oder absprechen. 2. Ein Ger\u00e4t oder Licht ausschalten.", example: "Wir haben ausgemacht, dass die Ware heute rausgeht. / Ich mache das Handy aus." },
    { german: "aufmachen", english: "to open (window, door, panel)", definition: "Etwas \u00f6ffnen, z.\u00a0B. ein Fenster, eine T\u00fcr oder eine Klappe.", example: "Ich mache erst mal das Fenster weit auf." },
    ...
    { german: "fertigmachen", english: "to finish / complete a task", definition: "Eine Aufgabe abschlie\u00dfen oder zu Ende bringen.", example: "Die Jungs k\u00f6nnen nichts mehr fertigmachen." },
    { german: "weitermachen", english: "to continue after an interruption", definition: "Eine unterbrochene T\u00e4tigkeit fortf\u00fchren.", example: "Wir versuchen, so gut es geht weiterzumachen." },
    { german: "abmachen", english: "to agree on / arrange (a date, a deal)", definition: "Etwas mit einer anderen Person vereinbaren oder festlegen.", example: "Wir hatten doch mit denen abgemacht, dass der Termin fix ist." },
    { german: "klarmachen", english: "to make clear / explain clearly", definition: "Etwas deutlich erkl\u00e4ren, sodass es jeder versteht.", example: "Ich mache ihnen klar, dass wir nichts daf\u00fcr k\u00f6nnen." },
    { german: "kaputtmachen", english: "to exhaust / wear out (coll.); to break", definition: "Etwas oder jemanden zerst\u00f6ren; umgangssprachlich auch: jemanden v\u00f6llig ersch\u00f6pfen.", example: "Mein Kopf f\u00fchlt sich an, als h\u00e4tte ihn jemand kaputtgemacht." },
    { german: "sich (zu jmdm.) aufmachen", english: "to set off toward someone", definition: "Sich auf den Weg zu einer Person oder einem Ort machen.", example: "Ich mache mich gleich zu euch auf." },
    { german: "jemanden bl\u00f6d anmachen", english: "to talk to someone rudely / aggressively", definition: "Jemanden unhöflich oder aggressiv ansprechen, oft grundlos.", example: "Er muss einen immer gleich bl\u00f6d anmachen." },
  ],
  idioms: [
    { german: "unter Strom stehen", english: "to be very stressed, tense", definition: "Sehr gestresst und angespannt sein, viel Druck sp\u00fcren.", example: "Ich stehe heute echt unter Strom." },
    { german: "der Wurm ist drin", english: "something keeps going wrong", definition: "Wenn immer wieder etwas schiefgeht und nichts funktioniert.", example: "Heute ist echt der Wurm drin." },
    { german: "auf dem Schlauch stehen", english: "to not get it, to be clueless", definition: "Etwas nicht verstehen oder nicht weiterwissen.", example: "Ich stehe nicht mehr v\u00f6llig auf dem Schlauch." },
    { german: "sich / andere nicht verr\u00fcckt machen", english: "to not stress yourself / others out", definition: "Sich oder andere nicht unn\u00f6tig stressen oder in Panik versetzen.", example: "Macht euch nicht verr\u00fcckt, wir bekommen das hin." },
    { german: "jemanden kirre machen", english: "to drive someone crazy", definition: "Jemanden so nerven oder unter Druck setzen, dass er fast verr\u00fcckt wird.", example: "H\u00e4tte mich so eine Situation komplett kirre gemacht." },
    { german: "auf eigene Faust", english: "on one's own, without permission", definition: "Etwas allein und ohne Erlaubnis oder Absprache tun.", example: "Bitte nichts auf eigene Faust an der Elektronik machen." },
    { german: "im Eimer sein", english: "to be broken / kaput", definition: "Kaputt, nicht mehr zu gebrauchen (umgangssprachlich).", example: "Kein Wunder, dass hier alles im Eimer ist." },
    { german: "an etwas rumpfuschen", english: "to tinker unprofessionally / botch something", definition: "Unprofessionell an etwas herumbasteln, sodass es eher schlimmer wird.", example: "Die Handwerker haben am Wochenende dran rumgepfuscht." },
    { german: "bei jemandem auf der Matte stehen", english: "to show up at someone's door unannounced", definition: "Pl\u00f6tzlich und unerwartet bei jemandem auftauchen.", example: "Der Hausmeister steht auf der Matte." },
    { german: "kommissionieren", english: "to pick and pack orders in a warehouse", definition: "Waren im Lager zusammenstellen und f\u00fcr den Versand vorbereiten (Fachbegriff aus der Logistik).", example: "Ohne Strom k\u00f6nnen wir nicht kommissionieren." },
    { german: "eine Verz\u00f6gerung aufholen", english: "to make up for a delay", definition: "Verlorene Zeit wieder gutmachen, einen R\u00fcckstand ausgleichen.", example: "Wir tun alles, um die Verz\u00f6gerung aufzuholen." },
    { german: "stramm stehen", english: "to stand at attention (out of respect/fear)", definition: "Sehr aufrecht und steif stehen, aus Respekt oder Angst vor einer Autorit\u00e4tsperson.", example: "Mehmet und ich stehen stramm wie zwei kleine Schuljungen." },
    { german: "duster", english: "very dark (colloquial)", definition: "Sehr dunkel, finster (umgangssprachlich f\u00fcr \u00abdu\u0308ster\u00bb).", example: "Im Lager ist es weiterhin duster." },
    { german: "lokaler Stromausfall", english: "local power outage", definition: "Wenn in einem begrenzten Gebiet pl\u00f6tzlich kein Strom mehr flie\u00dft.", example: "Es gibt einen lokalen Stromausfall." },
  ],
  exercises: [
    // --- LESEN ---
    {
...
const module2: CourseModule = {
  ...
  coreVerbs: [
    { german: "jemandem aus dem Kopf gehen", english: "to leave someone's mind", definition: "Wenn man st\u00e4ndig an etwas denken muss und es nicht vergessen kann.", example: "Das Lied geht mir nicht aus dem Kopf." },
    { german: "es geht um", english: "it's about", definition: "Das Thema oder der Inhalt einer Sache.", example: "Es geht um deine Zukunft." },
    { german: "auf die Nerven gehen", english: "to get on someone's nerves", definition: "Jemanden st\u00f6ren, nerven oder \u00e4rgern.", example: "Der L\u00e4rm geht mir auf die Nerven." },
    { german: "losgehen", english: "to set off / to start", definition: "Aufbrechen, sich auf den Weg machen; auch: anfangen.", example: "Wir gehen um 8 Uhr los." },
    { german: "auf jemanden zugehen", english: "to approach someone", definition: "Sich einer Person n\u00e4hern, um mit ihr zu sprechen oder Kontakt aufzunehmen.", example: "Sie ging auf mich zu und l\u00e4chelte." },
    { german: "es geht (jemandem) gut/schlecht", english: "someone is doing well/poorly", definition: "Beschreibt, wie sich jemand f\u00fchlt oder in welchem Zustand er ist.", example: "Mir geht es heute gut." },
    { german: "die Welt geht unter", english: "the world is ending (expr.)", definition: "\u00dcbertriebener Ausdruck f\u00fcr eine Situation, die dramatisch erscheint.", example: "So schlimm ist es nicht \u2013 die Welt geht nicht unter!" },
    { german: "etwas durchgehen", english: "to go through something", definition: "Etwas Schritt f\u00fcr Schritt pr\u00fcfen oder \u00fcberpr\u00fcfen.", example: "Gehen wir die Liste nochmal durch." },
    { german: "so geht es nicht weiter", english: "this can't go on like this", definition: "Ausdruck daf\u00fcr, dass sich eine Situation \u00e4ndern muss.", example: "So geht es nicht weiter, wir brauchen einen Plan." },
  ],
  idioms: [
    { german: "in der Schwebe sein", english: "to be up in the air / undecided", definition: "Wenn etwas noch nicht entschieden oder gekl\u00e4rt ist.", example: "Meine Pl\u00e4ne sind noch in der Schwebe." },
    { german: "seinen Weg gehen", english: "to go one's own way", definition: "Seinen eigenen Lebensweg verfolgen, unabh\u00e4ngig von anderen.", example: "Er ist seinen eigenen Weg gegangen." },
  ],
  exercises: [
    {
      id: "m2-mc-1",
